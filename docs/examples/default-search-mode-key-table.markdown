...
key_tables: {
    search_mode: [
      ...
      { key: phys:N, mods: CTRL, action: { CopyMode: NextMatch } }
      { key: phys:p, mods: CTRL, action: { CopyMode: PriorMatch } }
      { key: phys:r, mods: CTRL, action: { CopyMode: CycleMatchType } }
      { key: phys:U, mods: CTRL, action: { CopyMode: ClearPattern } }
