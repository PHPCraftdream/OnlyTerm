# `onlyterm.color.load_base16_scheme(file_name)`
...
Note that onlyterm ships with the base16 color schemes that were referenced via
...
that was created after your version of onlyterm was built.
...
```
> colors, metadata = onlyterm.color.load_base16_scheme("/tmp/cupcake.yaml")
> print(colors)
