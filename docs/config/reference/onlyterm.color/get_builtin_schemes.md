# `onlyterm.color.get_builtin_schemes()`
...
(In earlier releases, you can use [onlyterm.get_builtin_color_schemes()](../onlyterm/get_builtin_color_schemes.md))
...
local schemes = {}
for name, scheme in pairs(onlyterm.color.get_builtin_schemes()) do
...
local scheme = onlyterm.color.get_builtin_schemes()['Gruvbox Light']
...
local function dark_schemes()
  local schemes = onlyterm.color.get_builtin_schemes()
  local dark = {}
