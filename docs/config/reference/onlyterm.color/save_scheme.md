# `onlyterm.color.save_scheme(colors, metadata, file_name)`
...
Saves a color scheme as a onlyterm TOML file.
This is useful when sharing your custom color scheme with others.
While you could share the rhai representation of the scheme, the
...
```
> let scheme = color::load_base16_scheme("/tmp/cupcake.yaml")
> color::save_scheme(scheme.colors, scheme.metadata, "/tmp/cupcacke.toml")
```
