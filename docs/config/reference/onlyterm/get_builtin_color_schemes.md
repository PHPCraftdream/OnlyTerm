---
title: onlyterm.get_builtin_color_schemes
tags:
 - color
 - scheme
 - theme
...
# `onlyterm.get_builtin_color_schemes()`
...
This example shows how to make onlyterm pick a random color scheme for
...
local schemes = {}
for name, scheme in pairs(onlyterm.get_builtin_color_schemes()) do
...
local scheme = onlyterm.get_builtin_color_schemes()['Gruvbox Light']
...
local function dark_schemes()
  local schemes = onlyterm.get_builtin_color_schemes()
  local dark = {}
  for name, scheme in pairs(schemes) do
    -- parse into a color object
    local bg = onlyterm.color.parse(scheme.background)
...
[onlyterm.color.get_builtin_schemes()](../onlyterm.color/get_builtin_schemes.md)
but can still be called as `onlyterm.get_builtin_color_schemes()`. See that page
for more examples.
