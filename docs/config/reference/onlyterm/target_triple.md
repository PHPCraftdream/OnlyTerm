...
platform on which `onlyterm` was built.  This can be useful when you wish to
conditionally adjust your configuration based on the platform.

```lua
local onlyterm = require 'onlyterm'

if onlyterm.target_triple == 'x86_64-pc-windows-msvc' then
