---
title: onlyterm.gradient_colors
tags:
 - color
---

# `onlyterm.gradient_colors(gradient, num_colors)`
...
```
> onlyterm.gradient_colors({preset="Rainbow"}, 4)
...
[onlyterm.color.gradient](../onlyterm.color/gradient.md) and that name
