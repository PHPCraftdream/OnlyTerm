...
```
> onlyterm.color.parse("red"):contrast_ratio(onlyterm.color.parse("yellow"))
1
> onlyterm.color.parse("red"):contrast_ratio(onlyterm.color.parse("navy"))
1.8273614734023298
```
...
```
> onlyterm.color.parse("black"):contrast_ratio(onlyterm.color.parse("white"))
21
```
