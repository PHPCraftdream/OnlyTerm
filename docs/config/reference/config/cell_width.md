...
selecting a font using [onlyterm.font](../onlyterm/font.md) or
[onlyterm.font_with_fallback](../onlyterm/font_with_fallback.md) as that will
...
onlyterm considers to be the cell boundaries. When rendering monospace, onlyterm
