...
In this mode, if the application hasn't enabled mouse reporting, onlyterm will
...
In versions of onlyterm prior to this configuration option being available, the
