...
## Why doesn't onlyterm use the distro FreeType or match its configuration?

For the sake of consistency, onlyterm vendors in its own copy of
...
version of onlyterm are the same on all platforms regardless of
