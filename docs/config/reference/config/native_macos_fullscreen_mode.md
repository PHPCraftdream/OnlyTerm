...
Specifies whether the [ToggleFullScreen](../keyassignment/ToggleFullScreen.md)
...
for the onlyterm application and then slowly animate the onlyterm window moving
