# `onlyterm.mux.set_default_domain(MuxDomain)`
...
default domain that may have happened as a result of starting onlyterm via
`onlyterm connect` or `onlyterm serial`.
