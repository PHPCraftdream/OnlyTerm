...
В установленном WezTerm `20240203-110809-5046fc22`, который использовался как
...
Кроме того, сравнение текущего OnlyTerm с установленным WezTerm от 2024 года
одновременно меняет:
...
- отсутствие задержки у установленного WezTerm с парой ConPTY 2024 года.
