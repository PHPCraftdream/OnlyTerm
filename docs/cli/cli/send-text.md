# `onlyterm cli send-text`

*Run `onlyterm cli send-text --help` to see more help*
...
```
$ onlyterm cli send-text "hello there"
```
...
```
$ echo hello there | onlyterm cli send-text
```
...
```console
{% include "../../examples/cmd-synopsis-onlyterm-cli-send-text--help.txt" %}
```
