# `onlyterm cli list-clients`

*Run `onlyterm cli list-clients --help` to see more help*
...
user  foo  1098536 166.03140978s 31.40978ms default       0
```
...
```
$ onlyterm cli list-clients --format json
[
  {
    "username": "user",
    "hostname": "foo",
...
```console
{% include "../../examples/cmd-synopsis-onlyterm-cli-list-clients--help.txt" %}
```
