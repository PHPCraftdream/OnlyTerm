# `onlyterm cli move-pane-to-new-tab`

{{since('20220624-141144-bd1b7c5d')}}

*Run `onlyterm cli move-pane-to-new-tab --help` to see more help*
...
See also: [pane:move_to_new_window()](../../config/reference/pane/move_to_new_window.md),
[pane:move_to_new_tab()](../../config/reference/pane/move_to_new_tab.md).

## Synopsis

```console
{% include "../../examples/cmd-synopsis-onlyterm-cli-move-pane-to-new-tab--help.txt" %}
```
