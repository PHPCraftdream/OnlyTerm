# `onlyterm cli get-text`

{{since('20230320-124340-559cb7b0')}}

*Run `onlyterm cli get-text --help` to see more help*
...
```
$ onlyterm cli get-text > /tmp/myscreen.txt
```
...
```
$ onlyterm cli get-text --escapes > /tmp/myscreen-with-colors.txt
```
...
```console
{% include "../../examples/cmd-synopsis-onlyterm-cli-get-text--help.txt" %}
```
