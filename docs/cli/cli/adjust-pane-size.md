# `onlyterm cli adjust-pane-size DIRECTION`

{{since('20230712-072601-f4abf8fd')}}

*Run `onlyterm cli adjust-pane-size --help` to see more help*
...
```console
{% include "../../examples/cmd-synopsis-onlyterm-cli-adjust-pane-size--help.txt" %}
```
