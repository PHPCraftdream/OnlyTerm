...
use onlyterm_term::{ScrollbackOrVisibleRowIndex, StableRowIndex};
use onlyterm_termwiz_funcs::lines_to_escapes;
...
impl GetText {
    pub async fn run(self, client: Client) -> anyhow::Result<()> {
        ...
        let info = client
            .get_dimensions(onlyterm_codec::GetPaneRenderableDimensions { pane_id })
            .await?;
        ...
        let lines = client
            .get_lines(onlyterm_codec::GetLines {
                pane_id,
