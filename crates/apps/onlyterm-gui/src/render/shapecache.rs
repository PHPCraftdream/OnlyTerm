...
use onlyterm_font::shaper::GlyphInfo;
...
mod test {
    ...
    use onlyterm_config::{FontAttributes, TextStyle};
    use onlyterm_font::shaper::PresentationWidth;
    use onlyterm_font::{FontConfiguration, LoadedFont};
    use std::rc::Rc;
    ...
    #[test]
    fn ligatures_fira() {
        onlyterm_config::use_test_configuration();
        ...
        let mut config: onlyterm_config::Config = (*config).clone();
        ...
        onlyterm_config::use_this_configuration(config.clone());
