...
use onlyterm_config::keyassignment::SelectionMode;
use onlyterm_mux::pane::{Pane, Pattern, PatternType, SearchResult};
use onlyterm_term::{unicode_column_width, SemanticType, StableRowIndex};
use std::ops::Range;
use std::sync::Arc;
...
impl CopyRenderable {
    ...
    pub(super) fn schedule_update_search(&mut self) {
        ...
        let task = onlyterm_promise::spawn::spawn(async move {
