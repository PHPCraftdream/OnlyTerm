...
#[path = "input/actions.rs"]
pub(crate) mod actions;
#[path = "window/background.rs"]
pub mod background;
#[path = "panes/box_model.rs"]
pub mod box_model;
#[path = "panes/charselect.rs"]
pub mod charselect;
...
mod render_pipeline;
#[path = "window/resize.rs"]
pub mod resize;
#[path = "panes/selection.rs"]
mod selection;
...
lazy_static::lazy_static! {
    static ref WINDOW_CLASS: Mutex<String> = Mutex::new(onlyterm_gui_subcommands::DEFAULT_WINDOW_CLASS.to_owned());
...
fn open_config_file() -> anyhow::Result<()> {
    ...
    let path = onlyterm_config::Config::config_file_path();
    ...
    onlyterm_open_url::open_text_file(&path);
    Ok(())
}
...
pub struct TermWindow {
    ...
    pub config_overrides: onlyterm_dynamic::Value,
    ...
    /// implements.
    retained_rows: RefCell<HashMap<onlyterm_mux::pane::PaneId, render::RetainedPaneRows>>,
    ...
    /// WebGpu-render-thread path (the default on Windows; see `onlyterm_config::
    ...
    config_subscription: Option<onlyterm_config::ConfigSubscription>,
