...
use onlyterm_config::{ConfigHandle, Dimension, IntegratedTitleButtonColor};
...
mod windows {
    ...
    pub fn window_button_colors(
        background_lightness: f64,
        foreground: onlyterm_config::IntegratedTitleButtonColor,
...
pub fn window_button_element(
    ...
    let background_lightness = {
        let bg: onlyterm_config::RgbaColor = config.window_frame.active_titlebar_bg;
