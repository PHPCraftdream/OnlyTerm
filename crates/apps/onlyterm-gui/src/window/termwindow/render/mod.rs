...
#[path = "chrome/borders.rs"]
pub mod borders;
#[path = "cache/budget.rs"]
pub mod budget;
#[path = "line/cells.rs"]
mod cells;
#[path = "chrome/corners.rs"]
pub mod corners;
#[path = "line/draw.rs"]
pub mod draw;
#[path = "chrome/fancy_tab_bar.rs"]
pub mod fancy_tab_bar;
pub mod paint;
#[path = "pane/mod.rs"]
pub mod pane;
#[path = "line/screen_line.rs"]
pub mod screen_line;
#[path = "chrome/split.rs"]
pub mod split;
#[path = "chrome/tab_bar.rs"]
pub mod tab_bar;
#[path = "chrome/window_buttons.rs"]
...
impl crate::TermWindow {
    ...
    /// directly via `onlyterm_promise::spawn::spawn` + `Timer::at` +
...
pub fn shape_hash_lookup<F>(
    cache: &mut onlyterm_lfucache::LfuCache<ShapeHashCacheKey, ShapeHashEntry>,
...
fn resolve_fg_color_attr(
    ...
    config: &ConfigHandle,
    style: &onlyterm_config::TextStyle,
) -> LinearRgba {
    match fg {
...
#[cfg(test)]
#[path = "cache/cache_bench.rs"]
mod cache_bench;
#[cfg(test)]
#[path = "cache/retained_pane_rows_tests.rs"]
