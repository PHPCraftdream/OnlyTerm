...
use onlyterm_term::{SemanticZone, StableRowIndex};
...
pub use onlyterm_config::keyassignment::SelectionMode;
...
fn is_double_click_word(s: &str) -> bool {
    match s.chars().count() {
        1 => !onlyterm_config::configuration()
...
impl SelectionRange {
    ...
    pub fn zone_around(start: SelectionCoordinate, pane: &dyn onlyterm_mux::pane::Pane) -> Self {
