...
impl LocalPane {
    pub(in crate::model::localpane) fn process_tree_exe_names(
        &self,
        _policy: CachePolicy,
    ...
    pub(in crate::model::localpane) fn process_tree_allows_close(&self) -> bool {
    ...
    pub(in crate::model::localpane) fn divine_current_working_dir(
        &self,
        policy: CachePolicy,
    ) -> Option<Url> {
    ...
    pub(in crate::model::localpane) fn compute_proc_info(pid: u32) -> Option<CachedProcInfo> {
    ...
    pub(in crate::model::localpane) fn divine_process_list(
        &self,
        policy: CachePolicy,
    ...
    #[allow(dead_code)]
    pub(in crate::model::localpane) fn divine_foreground_process(
        &self,
        policy: CachePolicy,
