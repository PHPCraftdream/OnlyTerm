...
use onlyterm_config::{configuration, ExitBehavior, ExitBehaviorMessaging};
use onlyterm_dynamic::Value;
use onlyterm_procinfo::LocalProcessInfo;
...
/// `crates/apps/onlyterm-gui/src/termwindow/render/pane.rs`) only runs for
...
pub struct LocalPane {
    ...
    /// task #251) in `crates/apps/onlyterm-gui/src/termwindow/render/pane.rs`.
    ...
    /// loop in `crates/apps/onlyterm-gui/src/termwindow/render/pane.rs`, which
