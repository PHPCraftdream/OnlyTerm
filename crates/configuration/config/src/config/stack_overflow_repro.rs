...
//! `FontDatabase::with_font_dirs` (`crates/graphics/onlyterm-font/src/db.rs`)
...
//! `crates/graphics/onlyterm-font/src/db.rs`'s `stack_overflow_repro` module
...
//! (`crates/configuration/onlyterm-dynamic/derive/src/fromdynamic.rs`), and for a
