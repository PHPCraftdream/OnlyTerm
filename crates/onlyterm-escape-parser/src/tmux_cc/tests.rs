...
%output %1 \\033kuser@cube-localdomain:~\\033\\134\\033]2;user@cube-localdomain:~\\033\\134
%output %1 \\033]7;file://cube-localdomain/home/user\\033\\134
...
";
    ...
    assert_eq!(
        vec![
            ...
            Event::Output {
                pane: 1,
                text: "\x1bkuser@cube-localdomain:~\x1b\\\x1b]2;user@cube-localdomain:~\x1b\\"
                    .to_owned()
                    .as_bytes()
                    .to_vec()
            },
            Event::Output {
                pane: 1,
                text: "\x1b]7;file://cube-localdomain/home/user\x1b\\"
                    .to_owned()
                    .as_bytes()
                    .to_vec(),
            },
