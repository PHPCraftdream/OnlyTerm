...
//!
//! Mirrors `crates/wezterm-gui/src/termwindow/render/screen_line.rs`'s
...
//!
//! ```sh
//! cargo run -p wezterm-font --example render_line -- \
//!     --text "שלום עולם" --out /tmp/line.png
//! ```

use clap::Parser;
use config::FontAttributes;
use wezterm_font::db::FontDatabase;
use wezterm_font::parser::ParsedFont;
use wezterm_font::rasterizer::new_rasterizer;
use wezterm_font::shaper::{new_shaper, PresentationWidth};
...
fn main() -> anyhow::Result<()> {
    ...
    // `wezterm_bidi::ParagraphDirectionHint::direction`. `Line::cluster`
...
fn blit(
    ...
    glyph: &wezterm_font::rasterizer::RasterizedGlyph,
    x: i32,
    y: i32,
) {
