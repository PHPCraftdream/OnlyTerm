...
representative COLR/COLRv1 color glyphs, captured while `wezterm-font`'s
...
`wezterm-font/examples/diff_glyph.rs`.

## Provenance

- Captured at git rev: `047ffddc79d4c4ff7aab1060dc7b6b990ca5c5c6`
  ("wezterm-font: add tiny-skia painter module scaffolding (cairo
...
- Tooling: `wezterm-font/examples/dump_glyph.rs` (rasterize + PNG/JSON
  dump) and `wezterm-font/examples/diff_glyph.rs` (PNG diff), both
...
cargo run -p wezterm-font --example diff_glyph -- \
    --a wezterm-font/testdata/baseline/noto-emoji-U+1F600-freetype.png \
    --b /tmp/after-U+1F600-freetype.png \
    --meta-a wezterm-font/testdata/baseline/noto-emoji-U+1F600-freetype.json \
