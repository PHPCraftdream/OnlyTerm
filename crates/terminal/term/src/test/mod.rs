...
/// output (exactly what `crates/apps/onlyterm-gui/src/termwindow/render/screen_line.rs`
...
/// `crates/terminal/onlyterm-surface/src/cellcluster.rs` (`make_cluster_with_bidi`
